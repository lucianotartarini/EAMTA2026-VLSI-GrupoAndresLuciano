...
N -440 -180 -410 -180 {lab=bit}
N -360 -120 -360 -80 {lab=vss}
N -440 -290 -440 -180 {lab=bit}
N -360 -270 -360 -220 {lab=vdd}
N -440 -180 -440 -130 {lab=bit}
...
C {lab_pin.sym} -140 -230 0 0 {name=p14 sig_type=std_logic lab=vdd}
C {iopin.sym} -450 10 1 0 {name=p16 lab=out}
C {iopin.sym} -140 -190 2 0 {name=p17 lab=rst}
C {iopin.sym} -360 -80 0 0 {name=p3 lab=vss}
C {lab_pin.sym} -140 -130 0 0 {name=p4 sig_type=std_logic lab=vss}
